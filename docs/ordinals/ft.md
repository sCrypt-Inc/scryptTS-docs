...
1. I revised some sentences for clarity and conciseness.
2. In the code comments, using “the first sender” and “the second sender” seems more grammatically appropriate and consistent.
3. Used a more active
